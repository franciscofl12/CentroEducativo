package gui.panelValoracionMateriaMultiple;
...
public class PnlValoracionMultipleEstudiantes extends JPanel {

	JComboBox<Profesor> jcbProfesor;
	JComboBox<Materia> jcbMaterias;
	List<FichaValoracionPorEstudiante> fichasValoracion = new ArrayList<FichaValoracionPorEstudiante>();
	JScrollPane scrollPaneEstudiantes;
	
	/**
	 * Create the panel.
	 */
	public PnlValoracionMultipleEstudiantes() {
	...
	private void guardaValoraciones () {
		for (FichaValoracionPorEstudiante f : this.fichasValoracion) {
			f.guardaValoracion();
		}
